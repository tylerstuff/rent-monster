...
import { Button, Menu, MenuButton, MenuItem, MenuItems, Popover, PopoverButton, PopoverPanel } from '@headlessui/react'
            ...
            >
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div className="relative flex justify-between lg:gap-8">
                        <div className="flex md:absolute md:inset-y-0 md:left-0 lg:static xl:col-span-2">
                            <div className="flex flex-shrink-0 items-center">
                                <a href="#" className="flex flex-row gap-4 items-center">
                                    ...
                                    <p className="hidden lg:block font-semibold"><span className="text-rose-600">Rent</span> Monster</p>
                                </a>
                            </div>
                        </div>
                        ...
                        <div className="hidden lg:flex lg:items-center lg:justify-end xl:col-span-4" suppressHydrationWarning>
                            {theme === 'dark' ? <SunIcon className="w-8 h-8 text-gray-500 dark:text-gray-400" onClick={() => setTheme('light')} /> : <MoonIcon className="w-6 h-6 text-gray-500 dark:text-gray-400" onClick={() => setTheme('dark')} />}
                            {/* Profile dropdown */}
                            <button
                                type="button"
                ...
                <PopoverPanel as="nav" aria-label="Global" className="lg:hidden">
                        ...
                        {navigation.map((item) => (
                            <a
                                ...
                                className={classNames(
                                    item.current ? 'bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-white' : 'hover:bg-gray-50 dark:hover:bg-gray-700',
                    ...
                    <div className="border-t border-gray-200 dark:border-gray-700 pb-3 pt-4">
                        ...
                        <div className="mx-auto mt-0 max-w-3xl space-y-1 px-2 sm:px-4">
                            <a href="#" className="block rounded-md px-3 py-2 text-base font-medium text-gray-500 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-700 hover:text-gray-900 dark:hover:text-white">
                                Sign In
                            </a>
                            {/* {userNavigation.map((item) => (
                                <a
                            ...
                            {theme === 'dark' ? <SunIcon className="block rounded-md ml-3 w-8 h-8 text-gray-500 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-700 hover:text-gray-900 dark:hover:text-white" onClick={() => setTheme('light')} /> : <MoonIcon className="block rounded-md ml-3 w-8 h-8 text-gray-500 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-700 hover:text-gray-900 dark:hover:text-white" onClick={() => setTheme('dark')} />}
                        </div>
                    </div>
                </PopoverPanel>
            </Popover>
